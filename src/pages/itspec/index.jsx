          ...
          <Container>
            <div className="flex items-center xl:gap-32 md:gap-17 md:flex-row flex-col">
              ...
              <div className="md:w-6/12 w-full">
                ...
                <p>
                  Here will be information about Alisher Isaev, and there is
                  gonna be lots of lots of information. Here will be information
                  about Alisher Isaev, and there is gonna be lots of lots of
